...
### 1. Nexus Commerce Engine — Full-Stack E-Commerce & Inventory Management
...
*Technologies: Python, Django, DRF, React.js, SQLite/PostgreSQL*
- Engineered modular RESTful APIs for agile project tracking, Kanban boards, and milestone tracking.
- Implemented nested DRF serializers for complex multi-level task hierarchies and automated audit logs.
- Integrated optimistic UI dragging updates and responsive layout with zero layout shifts.

### 3. API Vault & Micro-Services — Secure REST Microservice Template
*Technologies: Django, DRF, Python, Token Auth, Swagger/OpenAPI*
- Designed reusable RESTful API boilerplate with token authentication, custom throttling, and Swagger documentation.
- Built automated database migrations, unit tests, and structured logging for maintainable enterprise services.
